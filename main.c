...
int main()
{
	...
	*/
	...
	printf("FANZONE 1 =%f", FANMAP_output[0].Max_output);
	printf("FANZONE 2 =%f", FANMAP_output[1].Max_output);
	printf("FANZONE 3 =%f", FANMAP_output[2].Max_output);
	printf("FANZONE 4 =%f", FANMAP_output[3].Max_output);
	free(currentConfig);
